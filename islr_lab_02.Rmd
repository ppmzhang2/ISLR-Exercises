---
title: "STAT318: 2. Regression Models"
...
The name for this dataset is simply "boston". It has two proto-tasks: `nox`, in which the nitrous oxide level is to be predicted; and `medv`, in which the median value of a home is to be predicted.
...
- Fitted vs Residuals
  - Whether linearity holds.
    ...
    In R this is indicated by the red line being close to the dashed
    line.
